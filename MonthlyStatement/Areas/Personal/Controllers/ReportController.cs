...
namespace MonthlyStatement.Areas.Personal.Controllers
{
    ...
    public class ReportController : Controller
    {
        ...
        public ActionResult PersonalDetail(int id)
        {
            ...
            ViewBag.PersonalReport = db.PersonalReports.FirstOrDefault(f => f.report_period_id == per);
        ...
        public ActionResult PersonalReportEdit(int id)
        {
            ...
            ViewBag.PerDetail = id;
            ViewBag.PersonalReport = db.PersonalReports.FirstOrDefault(p => p.report_period_id == per);
